package com.ldtteam.smithscore.client.events.models.block;
...
public class BlockModelUpdateEvent extends StandardNetworkableEvent
{
    ...
    {
        EventNetworkManager.getInstance()
          .sendToAllAround(getCommunicationMessage(Side.CLIENT),
            new NetworkRegistry.TargetPoint(dimensionID, blockPosition.getXComponent(), blockPosition.getYComponent(), blockPosition.getZComponent(), 128));
    }
