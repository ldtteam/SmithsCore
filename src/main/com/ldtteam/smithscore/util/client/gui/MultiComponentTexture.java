...
public class MultiComponentTexture
{
    ...
    {
        iCenterComponent = new TextureComponent(pSource.getPrimaryLocation(),
          pSource.getU() + pCornerWidth,
          pSource.getV() + pCornerHeight,
          pTotalWidth - (pCornerWidth * 2),
          pTotalHeight - (pCornerHeight * 2),
          new UIRotation(false, false, false, 0),
          new Coordinate2D(0, 0));

        iCornerComponents[0] = new TextureComponent(pSource.getPrimaryLocation(),
          pSource.getU(),
          pSource.getV(),
          pCornerWidth,
          pCornerHeight,
          new UIRotation(false, false, false, 0),
          new Coordinate2D(0, 0));
        iCornerComponents[1] = new TextureComponent(pSource.getPrimaryLocation(),
          pSource.getU() + pTotalWidth - pCornerWidth,
          pSource.getV(),
          pCornerWidth,
          pCornerHeight,
          new UIRotation(false, false, false, 0),
          new Coordinate2D(0, 0));
        iCornerComponents[2] = new TextureComponent(pSource.getPrimaryLocation(),
          pSource.getU() + pTotalWidth - pCornerWidth,
          pSource.getV() + pTotalHeight - pCornerHeight,
          pCornerWidth,
          pCornerHeight,
          new UIRotation(false, false, false, 0),
          new Coordinate2D(0, 0));
        iCornerComponents[3] = new TextureComponent(pSource.getPrimaryLocation(),
          pSource.getU(),
          pSource.getV() + pTotalHeight - pCornerHeight,
          pCornerWidth,
          pCornerHeight,
        ...
        iSideComponents[0] = new TextureComponent(pSource.getPrimaryLocation(),
          pSource.getU() + pCornerWidth,
          pSource.getV(),
          pTotalWidth - (pCornerWidth * 2),
          pCornerHeight,
          new UIRotation(false, false, false, 0),
          new Coordinate2D(0, 0));
        iSideComponents[1] = new TextureComponent(pSource.getPrimaryLocation(),
          pSource.getU() + pTotalWidth - (pCornerWidth),
          pSource.getV() + pCornerHeight,
          pCornerWidth,
          pTotalHeight - (pCornerHeight * 2),
          new UIRotation(false, false, false, 0),
          new Coordinate2D(0, 0));
        iSideComponents[2] = new TextureComponent(pSource.getPrimaryLocation(),
          pSource.getU() + pCornerWidth,
          pSource.getV() + pTotalHeight - pCornerHeight,
          pTotalWidth - (pCornerWidth * 2),
          pCornerHeight,
          new UIRotation(false, false, false, 0),
          new Coordinate2D(0, 0));
        iSideComponents[3] = new TextureComponent(pSource.getPrimaryLocation(),
          pSource.getU(),
          pSource.getV() + pCornerHeight,
          pCornerWidth,
          pTotalHeight - (pCornerHeight * 2),
