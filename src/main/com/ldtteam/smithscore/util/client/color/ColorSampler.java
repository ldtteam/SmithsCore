package com.ldtteam.smithscore.util.client.color;
...
public class ColorSampler
{
    ...
    private static void initializeEnumChatFromattingMinecraftColors()
    {
        ...
        map.chars().forEach(character ->
        {
            ...
            if (TextFormatting.values()[index].name().equals("BLACK"))
            {
                return;
            }
            ...
            iMappedColors.put(mappedColor, TextFormatting.values()[index]);
        });
    }
