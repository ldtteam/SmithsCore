...
/*        ClientRegistry registry = (ClientRegistry) SmithsCore.getRegistry();
    ...
    public void renderToolTipComponent(@Nonnull IGUIComponent component, int mouseX, int mouseY)
    {
        ...
        if ((component.getToolTipContent() != null && component.getToolTipContent().size() != 0) && (!(component instanceof IGUIBasedComponentHost))
              && !localPlane.ContainsCoordinate(mouseX, mouseY))
        {
            return;
        }
        ...
        ((IGUIBasedComponentHost) root).drawHoveringText(component.getToolTipContent(), globalMouseX + 4, globalMouseY + 4, CoreClientProxy.getMultiColoredFontRenderer());
    }
}
